...
const users = [
  {
    ...
    name: "Dennis Neele",
    title: "BodyJustice",
    address: "Waterloolaan 50, 9725 BE Groningen",
    website: "www.bodyjustice.nl",
    phoneNumber: "+31 683 804 169",
    email: "info@bodyjustice.nl",
    body: `
        Ik ben Dennis Neele, personal coach/ trainer en Physis Specialist.
        BodyJustice staat voor proactieve interventie op alle fronten van fysieke en mentale gezondheid. Opgericht voor mensen die besluiten hun lichaam serieus te nemen, inclusief de oorzaak van pijn en /of stress. Succes binnen 6 weken door een unieke mix van coaching, training, het 6-domeinen model en een persoonlijke aanpak. Ik ga verder dan het oplossen van de klacht en help ik mensen fysiek pijnvrij, fit en mentaal onbelemmerd te worden.
        `,
    image: {
      src: "https://storage.googleapis.com/physis_cms_storage/user.png",
      width: 80,
      height: 80,
    },
    lat: 53.2076564,
  ...
  },
  {
    id: "1",
    name: "Karin Coppens",
    title: "Health & Mindset Coach",
    address: "Boteyken 193-5, 3454 PD Utrecht",
    website: "www.bodyjustice.nl",
    phoneNumber: "+31 683 804 169",
    email: "info@bodyjustice.nl",
    body: `
  ...
  },
  {
    ...
    name: "Michael Kuster",
    title: "OCA Den Haag",
    address: "Rietgoornzoom 22, 3454 PD Emmen",
    website: "www.bodyjustice.nl",
    phoneNumber: "+31 683 804 169",
    email: "info@bodyjustice.nl",
    body: `
...
const GoogleMaps = ({
  ...
  return (
    <div className="relative flex">
      <div className="w-[32.5rem] bg-white md:min-w-[32.5rem]">
        <h2 {...setHtml(title)} className="mx-7 mb-6 mt-7 text-[22px]" />
        <div className="relative w-full px-7">
          <input
            value={address || ""}
            onChange={(e) => setAddress(e.target.value)}
            placeholder={placeholder}
            className="h-[3.75rem] w-full border-b border-[#E6E6E6] outline-main transition-all focus:px-5"
          />
