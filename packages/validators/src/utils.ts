...
export const notEmptyNumber = z
  ...
  export const formButton = z.object({ title: z.string(), href: z.string(), target: z.string().optional(), withArrow: z.boolean().optional(), variant: z.string().optional(), rounded: z.string().optional(), size: z.string().optional() })