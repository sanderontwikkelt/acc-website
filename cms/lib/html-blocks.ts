...
export const hero = {
  ...
  style: { paddingTop: 0, position: 'relative', backgroundColor: '#E9EAEC' },
  fields: {
    variant: {
      label: 'Variant',
      type: 'enum',
    ...
    image: {
      ...
      type: 'image',
      value: {
        src: 'https://storage.googleapis.com/physis_cms_storage/201711_PhysisAcademy_105146_D850_DSC_1271.png',
        width: 1108,
        height: 738,
        name: 'hero.png',
...
const content = {
  ...
  fields: {
    ...
    image: {
      ...
      value: {
        name: 'content.jpg',
        src: 'https://storage.googleapis.com/physis_cms_storage/content-preview.png',
        width: 389,
        height: 397,
      },
    },
