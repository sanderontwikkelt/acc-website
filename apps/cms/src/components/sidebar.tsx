...
export async function AdminSideBar({
  ...
  const [
    ...
    [EntityEnum.SPECIALIST, ActionEnum.FIND],
  );
  ...
  return (
    ...
    >
      <Card className="flex flex-grow flex-col p-0">
        <Link href="/">
          <SidebarItem className="relative flex w-full items-center justify-between p-5 pb-0">
            ...
            <svg
              ...
              viewBox="0 0 52 52"
              fill="none"
              className="h-[3.5rem] w-[3.5rem] fill-foreground py-1"
        ...
        <div className="max-h-[calc(100vh-13.125rem)] flex-grow overflow-auto">
          {(canFindPages ||
            canFindProducts ||
            canFindOrders ||
            canFindCarts) && (
            <>
              <SidebarItem>
                ...
                <SidebarItemContent>
                  ...
                  {canFindSpecialists && (
                    <SidebarItemLink href="/specialists">
