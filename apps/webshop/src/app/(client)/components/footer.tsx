    ...
    <footer className="bg-white">
      <div className="border-y border-[#e7e7e7] pt-[60px] md:pt-0">
        <div className="container mx-auto">
          <div className="-mx-4 grid gap-[1px] bg-[#e7e7e7] md:grid-cols-3">
            {[
              {
              ...
              <div key={title} className="w-full bg-white px-8">
                <div className="mb-[60px] text-center md:mt-[60px]">
                  ...
                  <div>
                    ...
                    <p className="text-body-color text-base font-medium md:text-sm lg:text-base">
                      {description}
                    </p>
                  </div>
                </div>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-5/12 xl:w-4/12">
              <div className="mb-16 max-w-[270px]">
                ...
                <div className="space-y-4">
                  <p className="text-body-color flex text-base font-medium">
                    <span className="pr-4">
                      <svg
                        width="24"
                        height="24"
              ...
              <div className="mb-16">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    { href: "/account/notifications", label: "Notificaties" },
                    ...
                    <li key={href}>
                      <Link
                        href={href}
                        className="text-body-color inline-block text-base font-medium hover:text-primary"
                      >
                        {label}
                      </Link>
                    </li>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-16">
                ...
                <ul className="space-y-3">
                  {[
                    { href: "/products/own-design", label: "Sportsokken" },
                    { href: "/products/own-design", label: "Bedrijfssokken" },
                    { href: "/products/own-design", label: "Eigen ontwerp" },
                    { href: "/products/own-design", label: "Upload je logo" },
                  ].map(({ href, label }) => (
                    <li key={href}>
                      <Link
                        href={href}
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-6/12 xl:w-3/12">
              <div className="mb-16">
                ...
                <div className="sm:flex md:block lg:flex xl:block">
                  <Link
                    href="/checkout"
                    className="mb-3 mr-3 flex w-full items-center justify-center rounded bg-primary px-2 py-3 hover:bg-opacity-90"
                  >
                  ...
                  <Link
                    ...
                    className="mb-3 mr-3 flex w-full items-center justify-center rounded bg-black px-2 py-3 hover:bg-opacity-90"
                  >
                    <span className="block pr-3">
        ...
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <p className="text-body-color text-base font-medium">
              © 2024 Sockwave. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
