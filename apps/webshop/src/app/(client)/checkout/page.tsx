          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
              <div className="mb-12 lg:mb-0">
                <h3 className="text-dark mb-8 text-2xl font-semibold dark:text-white">
                  Billing Details
                </h3>
                <form>
            ...
            <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
              ...
              <div className="shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark mb-8 overflow-hidden rounded-[10px] border border-border bg-white">
                <div className="dark:bg-dark-4 flex items-center justify-between bg-[#f9f9f9] px-6 py-[18px] 2xl:px-8">
                  <p className="text-dark text-base font-medium dark:text-white">
                    Product
                  </p>
                  <p className="text-dark text-right text-base font-medium dark:text-white">
                    Subtotal
                  </p>
                </div>
                ...
                <div className="dark:border-dark-3 -mx-1 border-b border-border p-6 2xl:px-8">
              ...
              <div className="shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark mb-8 overflow-hidden rounded-[10px] border border-border bg-white">
                <div className="dark:bg-dark-4 bg-[#f9f9f9] px-6 py-[18px] 2xl:px-8">
                  <h3 className="text-dark text-2xl font-bold dark:text-white">
                    Payment
                  </h3>
                </div>
...
const InputGroup = ({ type, placeholder }: any) => {
  return (
    <div className="w-full px-3 md:w-1/2">
      <div className="mb-8">
        <input
          ...
          className="text-body-color placeholder:text-dark-5 dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6 w-full rounded-md border border-border bg-transparent px-5 py-[14px] outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"
        />
      </div>
    </div>
  );
...
const SelectGroup = () => {
  return (
    <div className="w-full px-3 md:w-1/2">
      <div className="mb-8">
        <div className="relative">
          <select className="text-dark-5 dark:border-dark-3 dark:bg-dark-2 w-full appearance-none rounded-md border border-border bg-transparent px-5 py-[14px] outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]">
          ...
          <span className="text-body-color dark:text-dark-6 absolute right-5 top-1/2 -translate-y-1/2">
            <svg
...
const Textarea = ({ placeholder, rows }: any) => {
  return (
...
const CheckboxGroup = ({ id, labelTitle }: any) => {
  return (
    <div className="w-full px-3">
      <div className="mb-6">
        <label
...
const CouponBox = ({ title, button }: any) => {
  return (
    <div className="w-full px-4">
      <h3 className="text-dark mb-8 text-xl font-semibold dark:text-white">
        {title}
      </h3>

      <input
        type="email"
        className="text-body-color placeholder:text-dark-6 dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6 mb-3 mr-5 h-[50px] w-full max-w-[325px] rounded-md border border-border bg-white px-5 text-base outline-none focus:border-primary focus-visible:shadow-none"
        placeholder="Coupon code"
      />
      <button className="bg-dark dark:bg-dark-2 mb-3 h-[50px] rounded-md px-7 py-2 text-base font-medium text-white transition hover:bg-opacity-90">
        {button}
      </button>
    </div>
  );
...
const CartItem = ({ img, title, color, size, price }: any) => {
  return (
    <div className="dark:border-dark-3 -mx-1 flex items-center justify-between border-b border-border p-6 2xl:px-8">
      <div className="flex items-center px-1">
        <div className="mr-4 h-12 w-full max-w-[48px] overflow-hidden rounded">
          <img src={img} alt="product" className="w-full" />
        </div>
        <div>
          <p className="text-dark mb-0.5 text-base font-medium dark:text-white">
            {title}
          </p>
          <p className="text-body-color dark:text-dark-6 flex items-center space-x-3 text-sm sm:space-x-5 lg:space-x-3 2xl:space-x-5">
            <span>{color}</span>
            <span>{size}</span>
            <span>1 X {price}</span>
          </p>
