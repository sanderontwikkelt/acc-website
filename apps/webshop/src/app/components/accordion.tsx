...
export default function Accordion({
  ...
  return (
    <div
      className="w-full overflow-hidden border-b border-border transition-all duration-500"
      ref={parentRef}
      style={{ height: 100 }}
    >
      <button
      ...
      >
        ...
        <div className="relative h-5 w-5">
          <div
            className={cn(
              "bg-main absolute left-1/2 top-1/2 h-[3px] w-full -translate-x-1/2 -translate-y-1/2 transition-all duration-300",
