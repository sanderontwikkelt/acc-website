...
>(({ cb, ...props }, ref) => {
  ...
  return (
    <div ref={ref} {...props}>
      <label
        htmlFor="file"
        className="relative flex min-h-[175px] w-full cursor-pointer items-center justify-center rounded-md border border-dashed border-primary p-6"
      >
        <div>
          <input
            type="file"
          ...
          />
          <span className="dark:border-dark-3 dark:bg-dark-2 mx-auto mb-3 flex h-[50px] w-[50px] items-center justify-center rounded-full border border-border bg-white">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
