...
import ProductCategories3 from "./(client)/components/categories";
import Cta from "./(client)/components/cta";
import FeaturedProducts from "./(client)/components/featured-products";
...
const page = () => {
  return (
    <div>
      ...
      <FeaturedProducts />
      <section
        className="relative mb-40 bg-white"
        aria-labelledby="join-heading"
      >
        <div
          className="absolute inset-x-0 hidden h-1/2 lg:block"
          aria-hidden="true"
        />
        <div className="mx-auto max-w-7xl bg-primary lg:bg-transparent lg:px-8">
          <div className="lg:grid lg:grid-cols-12">
            ...
            <div className="relative bg-primary lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
              ...
              <div className="relative max-w-md space-y-6 px-6 py-12 sm:max-w-3xl sm:py-16 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
                <h2
                  className="text-3xl font-bold tracking-tight text-white lg:text-6xl"
                  id="join-heading"
                >
                  Wij zijn webshop
                </h2>
                ...
                <Link
                  className="block w-full rounded-md border border-transparent bg-white px-5 py-3 text-center text-base font-medium shadow-md hover:bg-slate-50 sm:inline-block sm:w-auto"
                  href="/about"
                >
                  Meer over ons
                </Link>
